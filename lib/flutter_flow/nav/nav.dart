...
class AppStateNotifier extends ChangeNotifier {
  ...
  ApricityAuthUser? initialUser;
  ApricityAuthUser? user;
  ...
  void update(ApricityAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: AttendanceLogsWidget.routeName,
          path: AttendanceLogsWidget.routePath,
          requireAuth: true,
          builder: (context, params) => AttendanceLogsWidget(),
        ),
        FFRoute(
