...
import 'mark_attendance_inner_model.dart';
export 'mark_attendance_inner_model.dart';

class MarkAttendanceInnerWidget extends StatefulWidget {
  const MarkAttendanceInnerWidget({
    super.key,
    required this.emp,
    required this.ward,
  });
  ...
  static String routeName = 'MarkAttendanceInner';
  static String routePath = '/markAttendanceInner';

  @override
  State<MarkAttendanceInnerWidget> createState() =>
      _MarkAttendanceInnerWidgetState();
}

class _MarkAttendanceInnerWidgetState extends State<MarkAttendanceInnerWidget>
    with TickerProviderStateMixin {
  late MarkAttendanceInnerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MarkAttendanceInnerModel());
      ...
      await Future.wait([
        Future(() async {
          ...
          if ((_model.geoLocationFeatched?.succeeded ?? true)) {
            ...
            _model.loc = functions.latlogReturn();
            safeSetState(() {});
