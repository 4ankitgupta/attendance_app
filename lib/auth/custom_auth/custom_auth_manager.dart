...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    apricityAuthUserSubject.add(
      ApricityAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ApricityAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ApricityAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ApricityAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    apricityAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
